...
export const DEMO_STAFF: Record<string, Staff[]> = {
  s1: [
    { id: 'st1', salonId: 's1', name: 'Rahul Mehta', bio: 'Senior stylist with 8 years of experience', specialization: 'Hair Coloring & Cuts', rating: 4.9, totalBookings: 520, isAvailable: true },
    { id: 'st2', salonId: 's1', name: 'Anjali Patel', bio: 'Skin & beauty specialist', specialization: 'Facials & Skin Care', rating: 4.8, totalBookings: 390, isAvailable: true },
    { id: 'st3', salonId: 's1', name: 'Vikram Singh', bio: "Men's grooming expert", specialization: 'Haircut & Beard', rating: 4.7, totalBookings: 280, isAvailable: false },
    { id: 'st4', salonId: 's1', name: 'Neha Joshi', bio: 'Nail art & body care', specialization: 'Nails & Waxing', rating: 4.6, totalBookings: 210, isAvailable: true },
  ],
  default: [
    { id: 'st1', salonId: '', name: 'Rahul Mehta', bio: 'Senior stylist', specialization: 'Hair', rating: 4.9, totalBookings: 520, isAvailable: true },
    { id: 'st2', salonId: '', name: 'Anjali Patel', bio: 'Skin specialist', specialization: 'Facials', rating: 4.8, totalBookings: 390, isAvailable: true },
    { id: 'st3', salonId: '', name: 'Neha Joshi', bio: 'Nail expert', specialization: 'Nails', rating: 4.7, totalBookings: 210, isAvailable: true },
  ],
};
